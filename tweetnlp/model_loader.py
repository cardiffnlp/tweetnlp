...
from .model_text_classification.model import Sentiment, Offensive, Irony, Hate, Emotion, Emoji, TopicClassification
...
def load(task_type: str = 'ner', model: str = None, max_length: int = 128, *args, **kwargs):
